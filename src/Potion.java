...
public class Potion extends Consumable{	//IDEA: a potion of confusion might make movements random, or cause the list of enemy monsters to change wildly
	...
	public String plural(Player player){	//TODO: override for each item type
		if(identified){
			switch(potionType)
			{
			case(GAIN_ABILITY):  return "potions of gain "+statType;
			case(LOSE_ABILITY):	 return "potions of lose "+statType;
			case(BOOST_ABILITY): return "potions of boost "+statType;
			default:
				return "potions of "+potionType;
			}
		}
		else if(player.itemKnown(this))
			return"potions of "+potionType;
		else
			return color+" potions";
	}
	...
	private String statType=""; //only for potions that influence stats
